...
<body>
<?php
    $conn = mysqli_connect("localhost","userdb","userdb","homeservices");
    if($conn==false){
...
<table>
    ...
    <tbody>
        ...
        <button class="btn btn-primary" onclick="window.location.href='himanshi/customer_page.php'">Go back to customer page</button>
    </center>
    </div>
      <div class="footer">
