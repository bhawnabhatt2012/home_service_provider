...
if(isset($_POST["go"])){ 
    if(!empty($_POST['login']) && !empty($_POST['password'])) {  
            ...
            $query=mysqli_query($con,"SELECT * FROM serviceproviderdb WHERE username='".$user."' AND password='".$pass."'");  
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="serviceprovider.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="login-form">
                <form method="post" id="login" action="../serviceprovider_profile.php">
