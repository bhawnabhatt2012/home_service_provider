      ...
      <!-- Modal Header -->
        ...
        <div class="parallax-window" data-parallax="scroll" data-image-src="laundryservices.jpg">
            <div style="padding-top:200px;" class="text-center">
                ...
                <div class="dropdown">
                    <a href="#" class="btn dropdown-toggle" data-toggle="dropdown" style="background-color:gainsboro;color:black;text-align:center">
                    <img src="location.png">Location
                    </a> &ensp;&emsp;<input type="text" placeholder="Search for a service" style="width: 500px;border-radius:8px;padding: 12px 20px;margin: 8px 0;" id="services">
                    <div class="dropdown-menu" style="opacity:1">
                        <a class="dropdown-item" href="#">Nungambakkam</a>
                        <a class="dropdown-item" href="#">Kodambakkam</a>
                        <a class="dropdown-item" href="#">Adyar Nagar</a>
