        ...
        <div class="modal fade" id="healthcare">
            <div class="modal-dialog">
                ...
                <ul style="list-style-type:none;">
                    <li><button type="button" style="width:400px;height:50px;padding:10px;border-radius:8px;text-align:left;" class="confirmation"  onclick="window.href='login.php'">
                            <img src="icons/stethoscope.png" style="width:20px;height:20px;">&ensp;&emsp;Dentist 
                        </button></li>
                    <li><button type="button" style="width:400px;height:50px;padding:10px;border-radius:8px;text-align:left;" onlick="window.location.href='login.php'">
                            <img src="icons/stethoscope.png" style="width:20px;height:20px;">&ensp;&emsp;Dietician
                        </button></li>
                    <li><button type="button" style="width:400px;height:50px;padding:10px;border-radius:8px;text-align:left;" class="confirmation" onlick="window.location.href='login.php'">
            ...
            <div class="modal-dialog">
                ...
                <ul style="list-style-type:none;">
                    ...
                    <li><button type="button" style="width:400px;height:50px;padding:10px;border-radius:8px;text-align:left;"
                                onlick="window.location.href='login.php'">
